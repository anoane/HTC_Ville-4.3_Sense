...
static char vle_e0[] = {0xF0, 0x5A, 0x5A}; 
static char vle_e1[] = {0xF1, 0x5A, 0x5A}; 
static char vle_e22[] = {0xFC, 0x5A, 0x5A}; 
static char vle_g0[] = {
	0xFA, 0x02, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00,
...
static char vle_g1[] = {0xFA, 0x03}; 
static char vle_p0[] = {
        0xF8, 0x27, 0x27, 0x08,
        0x08, 0x4E, 0xAA, 0x5E,
        0x8A, 0x10, 0x3F, 0x10, 0x10, 0x00}; 
static char vle_e2[] = {0xF6, 0x00, 0x84, 0x09}; 
static char vle_e3[] = {0xB0, 0x09}; 
static char vle_e4[] = {0xD5, 0x64}; 
static char vle_e5[] = {0xB0, 0x0B}; 
static char vle_e6[] = {0xD5, 0xA4, 0x7E, 0x20}; 
static char vle_e7[] = {0xF7, 0x03}; 
static char vle_e8[] = {0xB0, 0x02}; 
static char vle_e9[] = {0xB3, 0xC3}; 
static char vle_e10[] = {0xB0, 0x08}; 
static char vle_e11[] = {0xFD, 0xF8}; 
static char vle_e12[] = {0xB0, 0x04}; 
static char vle_e13[] = {0xF2, 0x4D}; 
static char vle_e14[] = {0xB0, 0x05}; 
static char vle_e15[] = {0xFD, 0x1F}; 
static char vle_e16[] = {0xB1, 0x01, 0x00, 0x16}; 
static char vle_e17[] = {0xB2, 0x10, 0x10, 0x10, 0x10}; 
static char vle_e17_C2[] = {0xB2, 0x15, 0x15, 0x15, 0x15}; 
...
static int ville_lcd_off(struct platform_device *pdev)
{
	...
	if (panel_type == PANEL_ID_VILLE_SAMSUNG_SG ||
		...
		cmdreq.cmds = auo_display_off_cmds;
...
static void ville_set_backlight(struct msm_fb_data_type *mfd)
{
	...
	ville_mipi_dsi_set_backlight(mfd);
